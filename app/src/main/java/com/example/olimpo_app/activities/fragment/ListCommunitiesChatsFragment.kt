 ...
 * Use the [ListCommunitiesChatsFragment.newInstance] factory method to
...
class ListCommunitiesChatsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ListCommunitiesChatsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ListCommunitiesChatsFragment().apply {
